...
def process_12digit_number(df, cells, output_file_name):
    ...
    try:
        for index, col, value in cells:
            ...
            if pd.notna(df.loc[index, "Samagra"]):
                continue
            ...
            pyautogui.click(x=960, y=388)  # Replace with actual coordinates
            pyautogui.hotkey("home")
            time.sleep(0.2)
            pyautogui.click(x=960, y=388)  # field
            time.sleep(0.2)
            pyautogui.click(x=960, y=388)  # field
            time.sleep(0.2)
            ...
            pyautogui.click(x=1121, y=379)  # Submit button

            # 5) Wait for 2 seconds
            time.sleep(10)
            pyautogui.click(x=1160, y=601)  # OK button
            ...
            if match:
                ...
                df.loc[index, "Samagra"] = "Not found"
                df.loc[index, "FPS"] = "Not found"
